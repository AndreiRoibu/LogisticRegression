...
def gradient_descent(X, y, y_hat, W, loss_function, learning_rate=0.1, steps=100):
    for step in range(steps):
        if step % 10 == 0:
            print(loss_function(y, y_hat))
        W += learning_rate * X.T.dot(y - y_hat)
...
if __name__ == '__main__':
    ...
    W = gradient_descent(X, y, y_hat, W, loss_function=cross_entropy, learning_rate=0.1, steps=100)
    print("Final W:", W)
